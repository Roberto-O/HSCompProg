...
static Scanner console = new Scanner(System.in);
	...
	int loopDecision, xC, yC, rC, hC;
        ...
        String desi = JOptionPane.showInputDialog(null, "Press: " + "\n" + "A for basic point" + "\n" + "B for Circle" + 
                "\n" + "C for Cylinder");
        
        
        if(desi.equals("A") || desi.equals("a")){
            String base1 = JOptionPane.showInputDialog(null,"Enter a X-Coordinate (1-10)");
                xC = Integer.parseInt(base1);
                String base2 = JOptionPane.showInputDialog(null,"Enter a Y-Coordinate (1-10)");
        ...
        else if(desi.equals("B") || desi.equals("b")){
            ...
            if(loopDecision == 1){ //user own value
                String base1 = JOptionPane.showInputDialog(null,"Enter a number 1-10 for the X coordinate. Center of the circle");
                xC = Integer.parseInt(base1);
                String base2 = JOptionPane.showInputDialog(null,"Enter a number 1-10 for the Y coordinate. Center of the circle");
                yC = Integer.parseInt(base2);
                String radi = JOptionPane.showInputDialog(null,"Enter the radius of the circle.");
		...
		System.out.println();
                JOptionPane.showMessageDialog( null, "Radius = " + p.getR()+ "\n"+
                        "Area of the circle = " + deci.format(p.area()) + "\n"+
                        "Circumference of the circle = " + deci.format(p.circumference()));
		...
		ycord = p.getX(); //no method needed. 2nd num
                xcord = p.getY();
                fx(xcord); //gets new 1st num
        ...
        else if(desi.equals("C") || desi.equals("c")){
            String loopdecis = JOptionPane.showInputDialog(null, "Enter 1 to insert your own value." + "Enter 2 to use preset values.");
            loopDecision = Integer.parseInt(loopdecis);
            if(loopDecision == 1){ //user own value
		...
		System.out.println();
                JOptionPane.showMessageDialog( null, "Radius = " + p.getR()+ "\n"+
                        "Height = " + p.getH() + "\n"+
                        "Volume of the cylinder = " + deci.format(p.volume()) + "\n" +
                        "Surface Area of the cylinder = " + deci.format(p.surfArea()));
